...
Axioms:
    ...
    forall V1 V2 (t(V1, V2) -> exists X Y (V1 = X and V2 = Y and exists Z Z1 (Z = X and Z1 = Y and (e(Z, Z1) and less_e_t(Z, Z1, V1, V2)))) or exists X Y Z (V1 = X and V2 = Y and (exists Z1 Z2 (Z1 = X and Z2 = Z and (e(Z1, Z2) and less_e_t(Z1, Z2, V1, V2))) and exists Z1 Z2 (Z1 = Z and Z2 = Y and (t(Z1, Z2) and less_t_t(Z1, Z2, V1, V2))))))
    forall V1 V2 (e(V1, V2) -> V1 = a1 and V2 = a2 and #true or V1 = a2 and V2 = a1 and #true)
...
Status: Theorem (30778 ms)

> Success! Anthem found a proof of equivalence. (30793 ms)
```
