...
tff(predicate_2, type, r: (general) > $o).
tff(formula_0_left_0, axiom, ![V1_g: general]: ((p(V1_g) => (q(V1_g) | (r(V1_g) => $false))) & ((q(V1_g) | (r(V1_g) => $false)) => p(V1_g)))).
tff(formula_1_left_1, axiom, ![V1_g: general]: ((r(V1_g) => V1_g = f__integer__(1)) & (V1_g = f__integer__(1) => r(V1_g)))).
tff(formula_2_left_2, axiom, ![V1_g: general]: ((q(V1_g) => V1_g = f__integer__(1)) & (V1_g = f__integer__(1) => q(V1_g)))).
tff(formula_3_right_0, conjecture, ![X_g: general]: (p(X_g))).
