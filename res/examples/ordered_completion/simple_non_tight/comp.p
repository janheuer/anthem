...
tff(formula_0_left_0, axiom, ![V1_g: general]: (p(V1_g) => ?[X_g: general]: (V1_g = X_g & ?[Z_g: general]: (Z_g = X_g & q(Z_g))))).
tff(formula_1_left_1, axiom, ![V1_g: general]: (p(V1_g) <= ?[X_g: general]: (V1_g = X_g & ?[Z_g: general]: (Z_g = X_g & q(Z_g))))).
tff(formula_2_left_2, axiom, ![V1_g: general]: (q(V1_g) => ?[X_g: general]: (V1_g = X_g & ?[Z_g: general]: (Z_g = X_g & p(Z_g))))).
tff(formula_3_left_3, axiom, ![V1_g: general]: (q(V1_g) <= ?[X_g: general]: (V1_g = X_g & ?[Z_g: general]: (Z_g = X_g & p(Z_g))))).
tff(formula_4_right_0, conjecture, ![X_g: general]: ((~p(X_g)) & (~q(X_g)))).
