...
tff(formula_10_right_0, axiom, p & q).
tff(formula_11_left_0, axiom, p).
tff(formula_12_left_1, axiom, p => q).
tff(formula_13_left_2, axiom, $true).
tff(formula_14_left_3, conjecture, q => (p & less_p_q)).
