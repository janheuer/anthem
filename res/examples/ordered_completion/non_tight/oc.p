...
tff(predicate_2, type, less_q_p: (general * general) > $o).
tff(predicate_3, type, less_p_q: (general * general) > $o).
tff(predicate_4, type, p: (general) > $o).
tff(predicate_5, type, q: (general) > $o).
...
tff(formula_2_oc_axiom_2, axiom, ![X1_g: general, X2_g: general, X3_g: general]: ((less_q_q(X1_g, X2_g) & less_q_q(X2_g, X3_g)) => less_q_q(X1_g, X3_g))).
tff(formula_3_oc_axiom_3, axiom, ![X1_g: general, X2_g: general, X3_g: general]: ((less_q_q(X1_g, X2_g) & less_q_p(X2_g, X3_g)) => less_q_p(X1_g, X3_g))).
tff(formula_4_oc_axiom_4, axiom, ![X1_g: general, X2_g: general, X3_g: general]: ((less_q_p(X1_g, X2_g) & less_p_q(X2_g, X3_g)) => less_q_q(X1_g, X3_g))).
tff(formula_5_oc_axiom_5, axiom, ![X1_g: general, X2_g: general, X3_g: general]: ((less_q_p(X1_g, X2_g) & less_p_p(X2_g, X3_g)) => less_q_p(X1_g, X3_g))).
tff(formula_6_oc_axiom_6, axiom, ![X1_g: general, X2_g: general, X3_g: general]: ((less_p_q(X1_g, X2_g) & less_q_q(X2_g, X3_g)) => less_p_q(X1_g, X3_g))).
tff(formula_7_oc_axiom_7, axiom, ![X1_g: general, X2_g: general, X3_g: general]: ((less_p_q(X1_g, X2_g) & less_q_p(X2_g, X3_g)) => less_p_p(X1_g, X3_g))).
tff(formula_8_oc_axiom_8, axiom, ![X1_g: general, X2_g: general, X3_g: general]: ((less_p_p(X1_g, X2_g) & less_p_q(X2_g, X3_g)) => less_p_q(X1_g, X3_g))).
tff(formula_9_oc_axiom_9, axiom, ![X1_g: general, X2_g: general, X3_g: general]: ((less_p_p(X1_g, X2_g) & less_p_p(X2_g, X3_g)) => less_p_p(X1_g, X3_g))).
tff(formula_10_left_0, axiom, ![V1_g: general]: (p(V1_g) <= ?[X_g: general]: (V1_g = X_g & ?[Z_g: general]: (Z_g = X_g & q(Z_g))))).
tff(formula_11_left_1, axiom, ![V1_g: general]: (q(V1_g) <= ?[X_g: general]: (V1_g = X_g & ?[Z_g: general]: (Z_g = X_g & p(Z_g))))).
tff(formula_12_left_2, axiom, ![V1_g: general]: (p(V1_g) => ?[X_g: general]: (V1_g = X_g & ?[Z_g: general]: (Z_g = X_g & (q(Z_g) & less_q_p(Z_g, V1_g)))))).
tff(formula_13_left_3, axiom, ![V1_g: general]: (q(V1_g) => ?[X_g: general]: (V1_g = X_g & ?[Z_g: general]: (Z_g = X_g & (p(Z_g) & less_p_q(Z_g, V1_g)))))).
tff(formula_14_right_0, conjecture, ![X_g: general]: ((~p(X_g)) & (~q(X_g)))).
