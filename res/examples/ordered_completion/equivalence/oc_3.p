...
tff(predicate_0, type, less_p_p: $o).
tff(predicate_1, type, less_q_q: $o).
tff(predicate_2, type, less_p_q: $o).
tff(predicate_3, type, less_q_p: $o).
tff(predicate_4, type, p: $o).
tff(predicate_5, type, q: $o).
tff(formula_0_oc_axiom_0, axiom, ~less_p_p).
tff(formula_1_oc_axiom_1, axiom, ~less_q_q).
tff(formula_2_oc_axiom_2, axiom, (less_p_p & less_p_p) => less_p_p).
tff(formula_3_oc_axiom_3, axiom, (less_p_p & less_p_q) => less_p_q).
tff(formula_4_oc_axiom_4, axiom, (less_p_q & less_q_p) => less_p_p).
tff(formula_5_oc_axiom_5, axiom, (less_p_q & less_q_q) => less_p_q).
tff(formula_6_oc_axiom_6, axiom, (less_q_p & less_p_p) => less_q_p).
tff(formula_7_oc_axiom_7, axiom, (less_q_p & less_p_q) => less_q_q).
tff(formula_8_oc_axiom_8, axiom, (less_q_q & less_q_p) => less_q_p).
tff(formula_9_oc_axiom_9, axiom, (less_q_q & less_q_q) => less_q_q).
tff(formula_10_left_0, axiom, p).
tff(formula_11_left_1, axiom, p => q).
tff(formula_12_left_2, axiom, $true).
tff(formula_13_left_3, axiom, q => (p & less_p_q)).
tff(formula_14_right_0, axiom, q).
tff(formula_15_right_1, axiom, q => p).
tff(formula_16_right_2, axiom, $true).
tff(formula_17_right_3, conjecture, p => (q & less_q_p)).
