...
tff(predicate_0, type, p: $o).
tff(predicate_1, type, q: $o).
tff(formula_0_left_0, axiom, p).
tff(formula_1_left_1, axiom, (q => p) & (p => q)).
tff(formula_2_right_0, axiom, q).
tff(formula_3_right_1, conjecture, (p => q) & (q => p)).
