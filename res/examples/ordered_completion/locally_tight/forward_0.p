...
tff(formula_0_left_0, axiom, ![V1_g: general]: ((p(V1_g) => (?[X_g: general]: (?[I_i: $int]: (V1_g = f__integer__($sum(I_i, 1)) & f__integer__(I_i) = X_g) & (p(X_g) & p__greater__(X_g, f__integer__(0)))) | V1_g = f__integer__(1))) & ((?[X_g: general]: (?[I_i: $int]: (V1_g = f__integer__($sum(I_i, 1)) & f__integer__(I_i) = X_g) & (p(X_g) & p__greater__(X_g, f__integer__(0)))) | V1_g = f__integer__(1)) => p(V1_g)))).
tff(formula_1_right_0, conjecture, ![X_i: $int]: ($greatereq(X_i, 1) => p(f__integer__(X_i)))).
